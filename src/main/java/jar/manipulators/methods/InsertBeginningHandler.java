...
public class InsertBeginningHandler extends ButtonEventHandler {



    public static ButtonEventHandler getDefault(TreeView<String> treeView, TextArea textArea, ListView<String> listView) {
        ButtonEventHandler buttonEventHandler = new InsertBeginningHandler("Insert code at the beginning of method", treeView, textArea, listView);
        return buttonEventHandler;
    }

    public InsertBeginningHandler(String name, TreeView<String> treeView, TextArea textArea, ListView<String> listView) {
        super(name, treeView, textArea, listView);
    }


    /**
     * Insert code at the beggining of selected method
            ...
            if (classpath.contains(".class")) {
                if (!listView.getSelectionModel().isEmpty()) {
                    ...
                    if(!textArea.getText().isEmpty()) {
                        methodToOverride.insertBefore(textArea.getText());
                    }
                }
                else
